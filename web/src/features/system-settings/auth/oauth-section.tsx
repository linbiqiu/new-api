...
const oauthSchema = z.object({
  ...
  feishu: z.object({
    ...
    auth_policy: z.string().optional(),
    init_webhook_secret: z.string().optional(),
  }),
})
...
const buildFormDefaults = (defaults: FlatOAuthDefaults): OAuthFormValues => ({
  ...
  feishu: {
    enabled: defaults['feishu.enabled'] ?? false,
    app_id: defaults['feishu.app_id'] ?? '',
    app_secret: defaults['feishu.app_secret'] ?? '',
    default_group: defaults['feishu.default_group'] ?? 'pending',
    auth_policy: defaults['feishu.auth_policy'] ?? 'parallel',
    init_webhook_secret: defaults['feishu.init_webhook_secret'] ?? '',
  },
})
...
const normalizeFormValues = (values: OAuthFormValues): FlatOAuthDefaults => ({
  ...
  'feishu.default_group': values.feishu.default_group ?? 'pending',
  'feishu.auth_policy': values.feishu.auth_policy ?? 'parallel',
  'feishu.init_webhook_secret': values.feishu.init_webhook_secret ?? '',
})
