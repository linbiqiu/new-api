            ...
            <SideDrawerSection>
              ...
              <div className='grid grid-cols-1 gap-3 sm:grid-cols-2'>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>{t('Bind Group')}</FormLabel>
                      <Select
                        items={[
                          { value: '__none__', label: t('No Bind') },
                          ...groupOptions.map((g) => ({ value: g, label: g })),
                        ]}
                        onValueChange={(v) =>
                          field.onChange(v === '__none__' ? '' : v)
                      ...
                      >
                        <FormControl>
                          <SelectTrigger>
                            <SelectValue placeholder={t('No Bind')} />
                          </SelectTrigger>
                        </FormControl>
                        <SelectContent alignItemWithTrigger={false}>
                          <SelectGroup>
                      ...
                      <FormDescription>
                        {t(
                          'Once bound, all users in this group automatically own this plan. Changes sync automatically.',
                        )}
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
