...
type SubscriptionFunding struct {
	...
	excludeBindGroup bool  // 付费分组请求时为 true，排除公司自动分配的订阅
	subscriptionId   int
	preConsumed      int64
...
func (s *SubscriptionFunding) PreConsume(_ int) error {
	...
	var err error
	if s.excludeBindGroup {
		res, err = model.PreConsumeUserSubscriptionExcludingBindGroup(s.requestId, s.userId, s.modelName, 0, s.amount)
	} else {
