...
func SetRelayRouter(router *gin.Engine) {
	...
	playgroundRouter.Use(middleware.UserAuth(), middleware.Distribute(), middleware.ModelQuotaLimit())
	{
	...
	relayV1Router.Use(middleware.ModelRequestRateLimit())
	{
		...
		wsRouter.Use(middleware.Distribute(), middleware.ModelQuotaLimit())
	...
	}
	{
		...
		httpRouter.Use(middleware.Distribute(), middleware.ModelQuotaLimit())
	...
	relaySunoRouter.Use(middleware.TokenAuth(), middleware.Distribute(), middleware.ModelQuotaLimit())
	{
	...
	relayGeminiRouter.Use(middleware.Distribute(), middleware.ModelQuotaLimit())
	{
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.TokenAuth(), middleware.Distribute(), middleware.ModelQuotaLimit())
	{
