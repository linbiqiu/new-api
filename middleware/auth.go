...
func TokenAuth() func(c *gin.Context) {
	return func(c *gin.Context) {
		...
		if tokenGroup != "" {
			// check common.UserUsableGroups[userGroup] + subscription bind_groups
			if _, ok := service.GetUserUsableGroupsWithSubscriptions(userGroup, userCache.Id)[tokenGroup]; !ok {
